...
// Récupérer le calendrier depuis la base de données
$sql = "SELECT cal.*, c.nom as culture_nom
FROM calendrier cal
JOIN cultures c ON cal.culture_id = c.id
ORDER BY c.nom ASC";
...
<strong style="color: var(--vert-principal); font-size: 0.85rem;">
<?php echo $item['periode_semis']; ?>
</strong>
</div>
</div>
<div class="col-6">
...
<strong style="color: #F57F17; font-size: 0.85rem;">
<?php echo $item['periode_recolte']; ?>
</strong>
</div>
</div>
</div>
...
<i class="fas fa-lightbulb me-1" style="color: var(--jaune);"></i>
<?php echo $item['conseils']; ?>
</p>
</div>
</div>
<?php endforeach; ?>
