...
<h4 class="fw-bold" style="color: var(--vert-principal);">
<?php echo round($jour['main']['temp']); ?>°C
</h4>
<p class="text-muted small"><?php echo ucfirst($jour['weather'][0]['description']); ?></p>
<small class="text-muted">
<i class="fas fa-tint"></i> <?php echo $jour['main']['humidity']; ?>%
</small>
</div>
</div>
<?php endforeach; ?>
...
<h5 class="fw-bold" style="color: var(--vert-principal);">
<i class="fas fa-lightbulb me-2"></i>Conseils du jour
</h5>
<div class="row g-3 mt-1">
<div class="col-md-4">
<p><i class="fas fa-check-circle me-2" style="color: var(--vert-clair);"></i>Arrosez tôt le matin pour limiter l'évaporation.</p>
</div>
<div class="col-md-4">
<p><i class="fas fa-check-circle me-2" style="color: var(--vert-clair);"></i>Protégez vos cultures des fortes chaleurs de l'après-midi.</p>
</div>
<div class="col-md-4">
<p><i class="fas fa-check-circle me-2" style="color: var(--vert-clair);"></i>Vérifiez l'humidité du sol avant d'irriguer.</p>
</div>
</div>
</div>
</div>
